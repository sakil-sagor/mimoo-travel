                                ...
                                >
                                    <div className='flex flex-col lg:flex-row list-none lg:ml-auto items-center	'>
                                        <div className='nav-item'>
                                            <NavLink className="manu-item p-2 text-lg font-bold text-white " to="/home">Home</NavLink >
                                        </div>

                                        <div className='nav-item'>
                                            <NavLink className="manu-item p-2 text-lg font-bold text-white" to="/services">Serivces</NavLink >
                                        </div>
                                        <div className='nav-item'>
                                        ...
                                        <div className="profile-holder py-3 ml-4">
                                            {
                                                user.email || user.displayName ?
                                                    ...
                                                    :
                                                    < NavLink className="manu-item p-2 text-lg font-bold text-pink-500 bg-white hover:text-pink-800 text-white rounded-md" to="/login"> LogIn </NavLink >
                                            }
