        ...
        <div className="bg-pink-700 pt-10  ">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 container full-width-all m-auto pb-8 px-2">
                ...
                <div className="col-sapn- ">
                    <NavLink to="/home">
                        <h1 className="text-4xl font-bold text-white ">Mimoo- <span className="text-blue-300">Travel</span> </h1>
                    </NavLink>
                    <p className="py-8 text-white font-semibold">Our goal is to deliver quality of care in a courteous, respectful, and compassionate manner. We hope you will allow us to care for you and strive to be the first and best choice for your family travel planer.</p>
                    <NavLink className="text-blue-300 font-semibold text-lg uppercase hover:text-white" to="/appointment">Make Booking <i class="fas fa-arrow-right ml-1"></i></NavLink>
                </div>
                {/* middle section */}
                ...
                <div className="col-sapn-12 ">
                    <div className="bg-pink-200 border-l-4 border-blue-500 rounded-lg p-4">
            ...
            <div className="bg-gray-900">
                <p className="py-4 text-center text-gray-500">© 2020 DataSoft, All Rights Reserved. With Love by mimoo-travel.com</p>
            </div>
        </div>
    );
};
