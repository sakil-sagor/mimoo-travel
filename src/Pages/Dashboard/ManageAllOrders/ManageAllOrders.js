...
const ManageAllOrders = () => {
  ...
  let handelAccept = (id) => {
    ...
    if (proceed) {
      const url = `https://mimoo-server.vercel.app/orders/${id}`;
      fetch(url, {
        method: "PUT",
        headers: {
  ...
  return (
    <div className="py-24 container m-auto full-width-all">
      <h2 className="text-center text-2xl py-4">
        You can manage all orders from here.
      </h2>
      <hr />
      {services.length ? (
        <div>
                ...
                <table className="w-full mt-12">
                  ...
                  <tr>
                    ...
                    <td className="bg-red-600 text-white hover:bg-red-700">
                      <button onClick={() => handelCancel(order._id)}>
                        Delete
                      </button>
                    </td>
                  </tr>
