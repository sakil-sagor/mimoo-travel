                        ...
                        <div className=" p-8 m-auto">
                            ...
                            <form >
                                ...
                                <div className="text-center pt-4">
                                    <button className="rounded-full py-2 px-4 border text-pink-600 text-lg font-semibold border-pink-500 hover:bg-pink-500 hover:text-white transition duration-500 ease-in-out " >Send Message</button>
                                </div>
                            </form>
                        </div>
                    </div>
