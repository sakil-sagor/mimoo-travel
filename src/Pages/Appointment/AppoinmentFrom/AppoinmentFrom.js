...
const AppoinmentFrom = () => {
    ...
    const handelRegister = e => {
        ...
        const newServices = { name, email, phone, packName, fromDate, toDate, status }
        ...
        fetch(' https://infinite-island-58921.herokuapp.com/orders', {
            ...
            .then(data => {
                if (data.insertedId) {
                    alert("success")
                    getPhone.current.value = getFromDate.current.value = getToDate.current.value = '';
                }
            })
        e.preventDefault();
                    ...
                    <div className="border-b-2 py-6 flex justify-start  items-center" >
                        ...
                        <div className="text-gray-500">
                            <NavLink to='/appointment'>
                                <h3 className="cursor-pointer font-bold">EMERGENCY APPOINTMENT</h3>
                            </NavLink>
                        </div>
                    ...
                    <div className=" p-8 m-auto">
                        <form onSubmit={handelRegister}>
                            ...
                            <div className="mb-4">
                                ...
                                <br />
                                <input type="text" id="name" value={user.displayName} ref={getName} required className="bg-white py-2 px-2 w-full rounded-2xl mt-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="email" className="text-gray-500 "> Your Email</label>
                                <br />
                                <input type="email" id="email" value={user.email} ref={getEmail} required className="bg-white py-2 px-2 w-full rounded-2xl mt-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="phone" className="text-gray-500 "> Your Phone</label>
                                <br />
                                <input type="number" id="phone" ref={getPhone} required className="bg-white py-2 px-2 w-full rounded-2xl mt-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="doctor" className="text-gray-500 "> Select Your Package</label>
                                <br />
                            ...
                            <div className="text-center pt-4">
                                <button className="rounded-full py-2 px-4 border text-pink-600 text-lg font-semibold border-pink-500 hover:bg-pink-500 hover:text-white transition duration-500 ease-in-out " >Order Now</button>
                            </div>
                        </form>
                    </div>
                </div>
